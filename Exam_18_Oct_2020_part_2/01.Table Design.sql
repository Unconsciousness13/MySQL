...
CREATE TABLE `products_stores`(
    ...
    CONSTRAINT fk_prodict_stores_products FOREIGN KEY (product_id) REFERENCES products(id),
    CONSTRAINT fk_prodict_stores_stores FOREIGN KEY (store_id) REFERENCES stores(id)
);
